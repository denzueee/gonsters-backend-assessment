...
def init_influxdb():
    ...
    try:
        influx_client = InfluxDBClient(
            url=config.INFLUXDB_URL, token=config.INFLUXDB_TOKEN, org=config.INFLUXDB_ORG, timeout=30000
        )
...
def write_sensor_data(machine_id, sensor_type, location, temperature=None, pressure=None, speed=None, timestamp=None):
    """
...
def query_sensor_data(  # noqa: C901
    machine_id=None, sensor_type=None, start_time=None, end_time=None, aggregation_window=None
):
    """
