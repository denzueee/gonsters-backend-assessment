...
def get_config():
    ...
    return jsonify({"status": "success", "config": CONFIG_STORE, "accessed_by": user.username}), 200
...
def reset_config():
    ...
    return jsonify({"status": "success", "message": "Configuration reset to defaults", "config": CONFIG_STORE}), 200
