...
import { Bell, AlertTriangle, AlertCircle, Info, X, Trash2, CheckCircle, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function AlertPanel() {
    ...
    return (
        <>
            {/* Mobile Toggle Button - Only visible when panel is closed */}
            {!isOpen && (
                <button
                    onClick={() => setIsOpen(true)}
                    className="fixed right-0 top-24 z-40 bg-primary-600 text-white p-3 rounded-l-lg shadow-lg hover:bg-primary-700 transition-all lg:hidden"
                    title="Show Alerts"
                >
                    <div className="flex items-center gap-2">
                        <Bell className="w-5 h-5" />
                        {alerts.length > 0 && (
                            <span className="absolute -top-1 -left-1 bg-red-500 text-white text-xs w-5 h-5 rounded-full flex items-center justify-center font-bold animate-pulse">
            ...
            {/* Alert Panel */}
            <div className={`
                w-96 bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 
                    ...
                    <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                className="lg:hidden p-1 hover:bg-gray-200 dark:hover:bg-gray-700 rounded transition-colors"
                                title="Hide Alerts"
                            >
