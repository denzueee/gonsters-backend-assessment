...
class TestAuthRoutes:
    ...
    def test_register_success(self, client, db_session):
        ...
        response = client.post("/api/v1/auth/register", data=json.dumps(payload), content_type="application/json")
    ...
    def test_register_duplicate(self, client, db_session):
        ...
        # Buat user awal
        existing_user = User(username="existing", email="existing@example.com", role="Operator")
        existing_user.set_password("Password123!")
        db_session.add(existing_user)
        db_session.commit()

        payload = {"username": "existing", "email": "other@example.com", "password": "Password123!", "role": "Operator"}
    ...
    def test_login_failure(self, client, db_session):
        ...
        payload = {"username": "failuser", "password": "WrongPassword!"}
