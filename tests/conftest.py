...
from app.database import Base, get_db, init_postgres_db
    ...
    try:
        ...
        if not test_bucket_exists:
            ...
            buckets_api.create_bucket(
                ...
                org="gonsters",
                retention_rules=[{"type": "expire", "everySeconds": 3600}],  # 1 hour
            )
...
def sample_machine(db_session):
    ...
    machine = MachineMetadata(
        name="Test-Machine-01", location="Test Floor 1", sensor_type="Temperature", status="active"
    )
